...
class UserMovieData {
  ...
  UserMovieData copyWith({bool? isFavorite, int? userRating, bool useUserRatingNullable = false}) {
  ...
  factory UserMovieData.fromJson(Map<String, dynamic> json) => _$UserMovieDataFromJson(json);
